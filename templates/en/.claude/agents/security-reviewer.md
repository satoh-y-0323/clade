...
## Report Output
After completing the assessment, always output the results to `.claude/reports/security-review-report-*.md` using Bash and ask the user for approval.
Follow the report output flow described in `.claude/rules/reviewer/security-reviewer.md`.
